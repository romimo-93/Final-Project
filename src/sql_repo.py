...
#seasonTeamPlayers = "select \"team_id\", \"teamName\" from \"season_team\" where \"season\" = " + season + " order by \"teamName\";"
#seasonTeams = "select \"team_id\", \"teamName\" from \"season_team\" where \"season\" = " + season + " order by \"teamName\";"


def MF_SQL(p_SQL):
    try:
        # Connect to an existing database
        connection = psycopg2.connect(user="administrator",
                                    password="hd##WWWWRY77",
                                    host="nhl-data.chuct8n1xntr.us-west-1.rds.amazonaws.com",
                                    port="5432",
                                    database="nhl_db")
